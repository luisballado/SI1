...
La industria en manufactura se ha basado en la rob\'{o}tica durante varias d\'{e}cadas. Las estad\'{i}sticas muestran que el crecimiento de la industria de la rob\'{o}tica sigue en constante crecimiento. Desde la instalaci\'{o}n del primer robot industrial en la d\'{e}cada de 1960 \textit{(https://www.invent.org/blog/inventors/George-Devol-Industrial-Robot)}, el sector se ha expandido continuamente a nuevos mercados y ha desarrollado nuevas aplicaciones para asistir a humanos, con la introducci\'{o}n de los primeros robots de servicio en las \'{u}ltimas d\'{e}cadas. A pesar de su novedad, los robots de servicio se est\'{a}n convirtiendo r\'{a}pidamente en una parte esencial del negocio para las empresas centradas en el servicio que buscan formas innovadoras de atender a los clientes mientras mejoran sus resultados. Los \textbf{robots de servicio} generalmente se utilizan para ayudar a los empleados en sus tareas diarias para que puedan concentrarse en el trabajo m\'{a}s valioso centrado en el cliente \textit{(https://www.intel.la/content/www/xl/es/robotics/service-robot.html)}. Entre ellos los drones, se han vuelto cada vez m\'{a}s frecuentes verlos en el mundo actual, encontrando aplicaciones en una amplia gama de industrias. En fotograf\'{i}a y video a\'{e}reas, puede obtener tomas a\'{e}reas sorprendentes e inmersivas para fines de filmaci\'{o}n, bienes ra\'{i}ces, turismo y entretenimiento. En la agricultura, los drones se utilizan para el control de cultivos, la fumigaci\'{o}n de precisi\'{o}n y la evaluaci\'{o}n del rendimiento, lo que mejora la productividad y la gesti\'{o}n de los recursos. En el mantenimiento de infraestructuras, los drones juegan un papel importante, ayudando en la inspeci\'{o}n de puentes, edificios, l\'{i}neas el\'{e}ctricas y tuber\'{i}as, reduciendo as\'{i} los riesgos y costos asociados con las inspecciones manuales. En misiones de b\'{u}squeda y rescate, donde ayudan en la localizaci\'{o}n de personas desaparecidas o en evaluaciones posteriores a un desastre, los drones han demostrado ser muy \'{u}tiles. Los estudios de vida silvestre, el mapeo de ecosistemas y el monitoreo de la salud de los bosques son algunas de las aplicaciones de los drones.\\ %Los datos para estudios clim�ticos, investigaci�n ambiental y estudios geol�gicos se pueden recopilar con la ayuda de veh�culos a�reos no tripulados. Mejorar el control fronterizo, el monitoreo de eventos p�blicos y la seguridad perimetral son algunas de las aplicaciones que han ganado terreno con el uso de drones. Las operaciones modernas en numerosos sectores se pueden hacer m�s eficientes y rentables con la ayuda de drones.

Hoy en d\'{i}a, los drones tienen muchas capacidades, as\'{i} como  una gama amplia de sensores que les permiten percibir su entorno con precisi\'{o}n. Siendo capaces de navegar a trav\'{e}s de entornos complejos, evitando obst\'{a}culos. Con la integraci\'{o}n del aprendizaje autom\'{a}tico y algoritmos de inteligencia artificial, los drones pueden tomar decisiones en tiempo real y adaptarse a las condiciones cambiantes. La mayoria de las aplicaciones son sencillas, est\'{a}ticas, en espacios controlados y rutas predeterminadas, para aplicaciones m\'{a}s complejas, donde el robot debe responder de manera aut\'{o}noma (con m\'{i}nima intervenci\'{o}n humana) a los cambios del medio ambiente, se requiere que el robot cuente con habilidades de identificaci\'{o}n de contextos, planificaci\'{o}n de tareas y manejo de mapas.\\

Algunos desarrollos importantes en estas \'{a}reas de investigaci\'{o}n se han centrado principalmente en sistemas con un \'{u}nico robot. No se puede subestimar la importancia de utilizar m\'{u}ltiples robots en las actividades de exploraci\'{o}n. Estos sistemas de m\'{u}ltiples robots ofrecen mayores beneficios que mejoran significativamente la efectividad y la eficiencia en tareas como la exploraci\'{o}n. En primer lugar, m\'{u}ltiples robots permiten la cobertura simult\'{a}nea de un \'{a}rea m\'{a}s grande, lo que permite una exploraci\'{o}n m\'{a}s completa del entorno. A cada dron se le pueden asignar tareas o \'{a}reas espec\'{i}ficas para enfocarse, asegurando que ninguna parte de la regi\'{o}n quede sin explorar. Esta cobertura integral conduce a una mejor comprensi\'{o}n del entorno y la capacidad de recopilar diversa informaci\'{o}n. Adem\'{a}s, los sistemas de m\'{u}ltiples robots permiten la ejecuci\'{o}n paralela de tareas, lo que reduce el tiempo de exploraci\'{o}n y maximiza la eficiencia. Los drones pueden colaborar, intercambiar informaci\'{o}n y optimizar sus rutas para minimizar la redundancia y agilizar el proceso de exploraci\'{o}n. Adem\'{a}s, el uso de m\'{u}ltiples drones mejora la solidez de la misi\'{o}n, ya que proporciona redundancia en caso de fallas de alg\'{u}n robot. Si un dron encuentra dificultades, otros drones pueden continuar la exploraci\'{o}n, asegurando la continuidad de la misi\'{o}n y reduciendo el riesgo de falla. Adem\'{a}s, los sistemas de drones m\'{u}ltiples permiten la especializaci\'{o}n de tareas, donde diferentes drones pueden equiparse con sensores o instrumentos especializados para recopilar tipos espec\'{i}ficos de datos. Esta especializaci\'{o}n aumenta la profundidad y la precisi\'{o}n de la recopilaci\'{o}n de datos, lo que genera conocimientos m\'{a}s valiosos. La escalabilidad y adaptabilidad de los sistemas de drones m\'{u}ltiples los hace muy adecuados para actividades de exploraci\'{o}n en varios escenarios y entornos, que van desde misiones de peque\~{n}a escala a gran escala o complejas. %En resumen, el uso de m�ltiples drones en actividades de exploraci�n mejora la cobertura, la eficiencia, la solidez, la especializaci�n y la adaptabilidad, lo que en �ltima instancia conduce a misiones de exploraci�n m�s exitosas y perspicaces.

%Ventajas de utilizar m\'{u}ltiples robots para realizar una misma tarea\\
%Nuevos problemas en sistemas multirobot (comunicaci\'{o}n, coordinaci\'{o}n, distribuci\'{o}n de tareas, fusi\'{o}n de datos, etc)\\
El uso de sistemas multirobot traen consigo retos inherentes que deben abordarse. La \textbf{coordinaci�n y colaboraci�n} entre m\'{u}ltiples robots presenta desaf\'{i}os en t\'{e}rminos de comunicaci\'{o}n, asignaci\'{o}n de tareas y sincronizaci\'{o}n. Establecer canales de comunicaci\'{o}n efectivos entre los robots es crucial para compartir informaci\'{o}n, coordinar acciones y evitar conflictos. Se requieren algoritmos de asignaci\'{o}n de tareas para distribuir diferentes tareas de exploraci\'{o}n entre los robots, teniendo en cuenta factores como la ubicaci\'{o}n, las capacidades y los niveles de energ\'{i}a para optimizar la divisi\'{o}n del trabajo. Adem\'{a}s, es fundamental garantizar la sincronizaci\'{o}n y evitar colisiones entre los robots en entornos din\'{a}micos. Es necesario implementar algoritmos para evitar colisiones y estrategias de planificaci\'{o}n de rutas para permitir movimientos seguros y eficientes de los robots, especialmente al explorar espacios complejos y desordenados. Adem\'{a}s, la integraci\'{o}n y fusi\'{o}n de datos de m\'{u}ltiples robots plantea desaf\'{i}os en t\'{e}rminos de sincronizaci\'{o}n, confiabilidad y consistencia de datos. Se deben emplear t\'{e}cnicas como la fusi\'{o}n de datos y el mapeo distribuido para combinar de manera efectiva los datos recopilados por los robots individuales en una representaci\'{o}n coherente del entorno. En general, la complejidad de las exploraciones de varios robots radica en abordar los desaf\'{i}os de la comunicaci\'{o}n, la asignaci\'{o}n de tareas, la sincronizaci\'{o}n, la prevenci\'{o}n de colisiones y la fusi\'{o}n de datos para garantizar resultados de exploraci\'{o}n eficientes y exitosos.

\textbf{DESCRIPCION DE LA PROPUESTA::: EN QU\'{E} CONSISTE Y PARA QU\'{E}}\\

El proyecto se centra en la colaboraci\'{o}n de m�ltiples VANT para tareas de exploraci\'{o}n, con el objetivo de desarrollar y evaluar una arquitectura de software en el que varios veh\'{i}culos a\'{e}reos no tripulados trabajen juntos para explorar entornos desconocidos de manera eficiente. Antes de profundizar en los detalles del proyecto, es fundamental definir qu\'{e} es un VANT.\\

Un VANT, tambi\'{e}n conocido como dron o \'{u}ltimamente como sistema a\'{e}reo no tripulado (UAS), se refiere a una aeronave que opera sin un piloto humano a bordo. Los VANT est\'{a}n equipados con varios sensores, sistemas de comunicaci\'{o}n y computadoras a bordo que les permiten operar de forma aut\'{o}noma o bajo control remoto. Estos aviones pueden ser de diferentes tama\~{n}os, desde peque\~{n}os modelos hasta m\'{a}quinas comerciales o militares m\'{a}s grandes.\\

En el contexto del proyecto de colaboraci\'{o}n multi-VANT para tareas de exploraci\'{o}n, estos VANT aut\'{o}nomos se utilizar\'{a}n para navegar y explorar entornos desconocidos. Al trabajar juntos de manera coordinada, los VANT compartir\'{a}n informaci\'{o}n, tareas y recursos, optimizando el proceso de exploraci\'{o}n para una mayor eficiencia y una cobertura integral. El proyecto tiene como objetivo desarrollar algoritmos, protocolos y estrategias que permitan que estos VANT se comuniquen de manera efectiva, asignen tareas, eviten obst\'{a}culos y exploren en colaboraci\'{o}n el entorno dado.\\

En general, el proyecto busca aprovechar las capacidades de los VANT para facilitar la exploraci\'{o}n eficiente y colaborativa de territorios desconocidos, al tiempo que mejora su autonom\'{i}a y coordinaci\'{o}n. Al aprovechar el potencial de la colaboraci\'{o}n multi-VANT, el proyecto tiene como objetivo contribuir a los avances en las t\'{e}cnicas de exploraci\'{o}n y expandir las aplicaciones de los VANT en varios dominios.
...
%En el contexto del proyecto de exploraci\'{o}n multi-VANT, se utilizar\'{a}n para navegar y explorar entornos desconocidos. Al trabajar juntos de manera coordinada, los VANT compartir\'{a}n informaci\'{o}n, optimizando el proceso de exploraci\'{o}n para una mayor eficiencia y una cobertura. El proyecto tiene como objetivo desarrollar algoritmos, protocolos y estrategias que permitan que estos VANT se comuniquen de manera efectiva, asignen tareas, eviten obst\'{a}culos y exploren en colaboraci\'{o}n el entorno dado.\\
...
Los avances tecnol\'{o}gicos son una secuencia de conocimientos y experiencia a lo largo del tiempo, ya no nos sorprende observar los veh\'{i}culos a\'{e}reos no tripulados (VANT) hoy en d\'{i}a, convirti\'{e}ndose en una herramienta que emerge principalmente de la milicia. Se reporta en la literatura el uso temprano de globos de helio con cargas explosivas usado por el ejercito austriaco como t\'{e}cnicas militares. Por otra parte, los trabajos de los hermanos br\'{e}guet en 1907 remontan la idea e implementaci\'{o}n del concepto de multi-rotor, no obstante a pesar que solo pudo levantarse pocos cent\'{i}metros del suelo, no fue hasta 1917 que el primer VANT de ala fija fu\'{e} presentado, \'{e}ste avance incorpor\'{o} tecnol\'{o}gia de radio control desarrollada por Nikola Tesla en 1898 convirti\'{e}ndose en el primer avi\'{o}n piloteado remotamente de la historia. A pesar de que su invento fu\'{e} con fines militares, nunca se hizo uso de \'{e}l.\\

Los avances tecnol\'{o}gicos en electr\'{o}nica impulsados por la introducci\'{o}n del transistor permitieron la reducci\'{o}n de componentes electr\'{o}nicos, comenzando a ser cada vez m\'{a}s populares los aviones de radio control para uso recreativo.\\
Diversos emprendimientos emergieron a ra\'{i}z de los hobbys de radio control siendo uno de ellos la empresa alemana Micro-Drones que dentro de su portal remonta los origenes de la empresa al a\~{n}o 2001 con el prototipo de unVANT multi-rotor controlado a distancia, 2009 por el mexicano Jordi Mu\~{n}oz con capital extranjero crea la empresa 3DR.\\

En el a\~{n}o 2010 a ra\'{i}z de la introducci\'{o}n  del AR-DRONE cuya conectividad v\'{i}a WIFI y bajos costos, permitier\'{o}n inovar y pensar en dotar de autonom\'{i}a. A ra\'{i}z de la fuerte adopci\'{o}n de esta tecnolog\'{i}a para uso civil, se han presentado diversas regulaciones de vuelo con la intenci\'{o}n de minimizar los accidentes a\'{e}reos.\\

Los primeros trabajos de autonom\'{i}a con veh\'{i}culos a\'{e}reos no tripulados a partir del uso de AR-Drone considerada una plataforma para la investigaci\'{o}n y educaci\'{o}n \cite{ARDRONE2011} fueron sencillos, detectar colores con el uso de las c\'{a}maras del VANT, seguir marcadores, aterrizar al detectar ciertos tags, crear mapas con fotograf\'{i}as e inclusive crear controles de vuelo a partir de l\'{o}gica difusa. Ampliando el panorama de las posibles aplicaciones civiles que un VANT puede proporcionar.\\
Debido a su poca autonom\'{i}a de vuelo y limitados sensores, los avances en el \'{a}rea migraron a plataformas m\'{a}s complejas y soluciones a la medida.\\

En 2013, Amazon Prime present\'{o} su inter\'{e}s para la entrega r\'{a}pida de productos. Siendo un proyecto prometedor, pero debido a las capacidades tecnol\'{o}gicas el proyecto no se culmin\'{o} y qued\'{o} descontinuado. El c\'{o}mo dotar de autonom\'{i}a a un VANT es un campo activo de investigaci\'{o}n. \cite{Bekey2005} en su libro define un robot aut\'{o}nomo como una  m\'{a}quina inteligente capaz de ejecutar diversas tareas en un ambiente por si mismo, sin que algui\'{e}n gu\'{i}e sus movimientos.\\

La navegaci\'{o}n aut\'{o}noma ha sido un campo activo en rob\'{o}tica m\'{o}vil por m\'{a}s de 60 a\~{n}os, tendiendo grandes avances en autonom\'{i}a, percepci\'{o}n de informaci\'{o}n y controles reactivos, emergiendo algoritmos de exploraci\'{o}n y navegaci\'{o}n, conceptos como mapeo y localizaci\'{o}n simult\'{a}neos y arquitecturas de control simples.\\

Debido a que un veh\'{i}culo aereo no tripulado multi-rotor es marginalmente estable el progreso de autonom\'{i}a tom\'{o} como primera etapa controlar y estabilizar el VANT en el aire con algoritmos r\'{a}pidos que permitieron crear maniobras cada vez m\'{a}s complejas y agresivas. Avances en evaci\'{o}n de obst\'{a}culos, planificaci\'{o}n de trayectorias, el mapeo de su entorno con diversos sensores han permitido dotar de autonom\'{i}a sin necesidad de GPS.\\
...
Para considerar a un robot aut\'{o}nomo, \'{e}ste deber\'{a} responder tres preguntas
  ...
  Los v\'{e}hiculos a\'{e}reos no tripulados tienen cualidades sobresalientes que los vuelven adecuados para la exploraci\'{o}n. La movilidad, una perspectiva privilegiada de su entorno y su dinamismo, teniendo acceso r\'{a}pido a zonas afectadas por desastres, permiti\'{e}ndoles llegar a \'{a}reas que pueden ser inaccesibles para otro tipo de robot. El uso adecuado de m\'{u}ltiples v\'{e}hiculos a\'{e}reos no tripulados (VANT) proporciona robustez, brindando resilencia frente a fallas de un VANT siendo una de las principales ventajas del uso de sistemas multi-robot.\\
...
\begin{vtimeline}[description={text width=14cm}, 
 row sep=8ex, 
 use timeline header,
 timeline title={VANT Autonom�a}]
2010 & Aparici\'{o}n de los primeros VANT comerciales de bajo costo con funciones b\'{a}sicas y control por WIFI.\endlr
2011 & Mejoras en la estabilizaci\'{o}n y el control de vuelo.\endlr
2012 & Integraci\'{o}n de tecnolog\'{i}as de visi\'{o}n por computadora permitiendo realizar el reconocimiento y seguimiento de objetos.\endlr
2013 & Los sistemas de detecci\'{o}n y evasi\'{o}n de obst\'{a}culos equipan a los VANT con la capacidad de navegar de forma aut\'{o}noma alrededor de los obst\'{a}culos en su trayectoria de vuelo.\endlr
2014 & Con el uso de algoritmos para SLAM, los VANT pueden construir mapas de su entorno en tiempo real mientras estiman sus propias posiciones.\endlr
2015 & Avances significativos en el control de m\'{u}ltiples VANT.\endlr
2016 & Desarrollo de planificaci\'{o}n de rutas que permite a los VANT naveguen de forma aut\'{o}noma a trav\'{e}s de entornos complejos y din\'{a}micos.\endlr
2017 & Adopci\'{o}n de algoritmos de aprendizaje profundo mejora el reconocimiento y el seguimiento de objetos, lo que permite que los VANT detecten y sigan objetivos espec\'{i}ficos u objetos de inter\'{e}s de forma aut\'{o}noma.\endlr
2018 & T\'{e}cnicas de aprendizaje autom\'{a}tico e inteligencia artificial que permiten mejorar las capacidades de toma de decisiones, permitiendo adaptarse a las condiciones cambiantes y tomen decisiones inteligentes en tiempo real.\endlr
2019 & Integraci\'{o}n de t\'{e}cnicas avanzadas de fusi\'{o}n de sensores, combinando datos de m\'{u}ltiples sensores, mejora la percepci\'{o}n y el conocimiento de la situaci\'{o}n de los VANT, mejorando sus capacidades de vuelo aut\'{o}nomo en diversos entornos.\endlr
2020 & Los avances continuos en la autonom\'{i}a de los VANT incluyen el uso de computaci\'{o}n a bordo con sistemas capaces de manejar tareas de procesamiento complejas, reduciendo la dependencia de recursos computacionales externos.\endlr
2021 & La investigaci�n en curso se centra en el desarrollo de sistemas de VANT aut�nomos con capacidades mejoradas de comunicaci�n y colaboraci�n, lo que permite que los VANT trabajen juntos sin problemas para misiones complejas, como b�squeda y rescate o inspecci�n de infraestructura.\endlr
\end{vtimeline}
...
\phantom{La colaboraci\'{o}n entre robots de manera coordinada ofrece ventajas en comparaci\'{o}n con el uso de un solo robot como la distribuci\'{o}n de tareas, redundancia de informaci\'{o}n, cubir mayores \'{a}reas. Pero la coordinaci\'{o}n y comunicaci\'{o}n entre ellos puede aumentar la complejidad del sistema, para ello debemos de dotarlos de algoritmos r\'{a}pidos para garantizar una operaci\'{o}n eficiente.\\}

\phantom{Existen desaf\'{i}os inherentes con la exploraci\'{o}n multi-VANT. Una coordinaci\'{o}n que garantice no colisonar entre ellos, manteniendo una distancia que no comprometa la integridad de los m\'{u}ltiples VANT y la comunicaci\'{o}n efectiva con sus vecinos son desaf\'{i}os que deben abordarse.\\}

\phantom{El \'{e}xito de sus misiones dependen de alcanzar un determinado lugar para que puedan realizar ciertas acciones.\\}
...
%Obteniendo los siguientes resultados cuando el tama\~{n}o del voxel es de 10 cm, OctoMap-RT es 49.3x r\'{a}pido que OctoMap y 8.7x r\'{a}pido que SuperRay Variantes de OctoMap: SuperRay, \textbf{OctoMap-RT}
