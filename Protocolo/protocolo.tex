...
\end{itemize}
  ...
  \begin{tabular}{ |p{2cm}|p{1.5cm}|p{1.5cm}|p{1.4cm}|p{7.5cm}|  }
    \hline
    Metodo& Completo & Optimo& Escalable& Notas \\
    \hline
    \rowcolor{black!5}
    Visibility   & Si    & Si&   No& Poca escalabilidad, el robot pasa cerca de los obstaculos\\
    \hline
    Voronoi   & Si    & No& No& Poca escalabilidad\\
    \hline
    \rowcolor{black!5}
    Potential field   & Si    & No& Depende del ambiente& Facil de implementar, suceptible a minimos locales\\
    \hline
    Dijkstra/A*   & Si    & Grid& No& A* usa una funcion heuristica que guia la busqueda mas eficiente, Poca escalabilidad\\
    \hline
    \rowcolor{black!5}
    PRM   & Si    & Grafo& Si& Eficiente para multi-busquedas, completez probabilistica \\
    \hline
    RRT   & Si    & No & Si& Eficiente para problemas simples, completez probabilistica\\
    \hline
  \end{tabular}\\
