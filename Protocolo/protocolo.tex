...
Los trabajos de \cite{CIESLEWSKI2017} hacen uso de representaci\'{o}n del entorno con ayuda de voxel 3D, planifican trayectorias de exploraci\'{o}n para un VANT basado en fronteras con un VANT utilizando un modo reactivo generando una ruta hacia las nuevas fronteras a explorar.\\
Los trabajos de \cite{USENKO2017} proponen el uso del mapa centrando al robot en un circulo tridimensional de tama\~{n}o fijo.\\
Los trabajos de \cite{MOHTA2017} hacen uso de un mapa h\'{i}brido formado con la combinaci\'{o}n de un mapa 3D con un mapa global en 2D\\
Los trabajos de \cite{LIN2017}\\
Los trabajos de \cite{PAPACHRISTOS2017} presentan algoritmos para la exploraci\'{o}n aut\'{o}noma, hacen una exploraci\'{o}n construyendo un \'{a}rbol aleatorio de exploraci\'{o}n r\'{a}pida RRT a partir de nuevos puntos, buscando el camino que minimize la incertidumbre del robot con los puntos de referencia del mapa.\\
Los trabajos de \cite{OLEYNIKOVA2018} hacen uso de tablas hash que proporcionan una representac\'{o}n del entorno con r\'{a}pidos tiempos de inserci\'{o}n y consulta de complejidad constante\\
Los trabajos de \cite{GAO2018} 
Los trabajos de \cite{FLORENCE2018}\\
Los trabajos de \cite{SELIN2019} hacen uso del algoritmo RRT insertando valores altos a los vertices con mayores ganancias de informaci\'{o}n que son usados como objetivos de planificaci\'{o}n. \\
...
Los trabajos de \cite{COLLINS2019} usan una representaci\'{o}n local del mapa como un KD-Tree cib yb naoa de voxels, mientras que un grafo topol\'{o}gico representa todo el entorno explorado\\
Los trabajos de \cite{CIESLEWSKI2021} han demostrado poder descentralizar la tarea de SLAM para la creaci\'{o}n de mapas\\
Los trabajos de \cite{CINVES2021} presenta una arquitectura para un VANT con la habilidad de explorar y navegaciones hacia objetivos con ayuda se su propia representaci\'{o}n de octomaps y planificador global de tipo RRT\\
Los trabajos de \cite{RACER2022} presentan una arquitectura descentralizada multi-VANT\\
Los trabajos de \cite{WESTHEIDER2023}\\
Los trabajos de \cite{BARTOLOMEI2023}\\
