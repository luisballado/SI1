...
\hline
Metodo&Completez&Optimo&Escalable&Notas\\
\hline
Grafo de visibilidad & Si & Si & No & \begin{itemize}[left=0pt,topsep=0pt]
...
\end{itemize}\nointerlineskip\\
\hline
Voronoi & Si & No & No & \begin{itemize}[left=0pt,topsep=0pt]
\item Espacio libre m\'{a}ximo
\item Rutas conservadoras
\item Mala escalabilidad
\end{itemize}\nointerlineskip\\
\hline
Potential field & Si & No & Depende del ambiente & \begin{itemize}[left=0pt,topsep=0pt]
\item F\'{a}cil de implementar
\item Suceptible a m\'{i}nimos locales
\end{itemize}\nointerlineskip\\
\hline
Dijkstra/A* & Si & Grid & No & \begin{itemize}[left=0pt,topsep=0pt]
...
\begin{landscape}
\begin{center}
    \begin{tabular}{ | l | p{5cm} | p{4cm} | l | p{1.5cm} |}
      \hline
      REFERENCIA&
      MAPA&
