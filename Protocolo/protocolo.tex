...
\st{Un veh\'{i}culo a\'{e}reo no tripulado (VANT), com\'{u}nmente conocido como dron, hace referencia a una aeronave sin tripulaci\'{o}n, la cual ej
  erce su funci\'{o}n remotamente o controlada de forma aut\'{o}noma.}
