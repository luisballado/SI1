...
\hline
\textbf{E2.A4.} Desarrollo de visualizaci\'{o}n de datos   \off[2] \on[3]  \off[7] \\
\hline
\textbf{E2.A5.} Desarrollo de algoritmos de exploraci\'{o}n  \off[3] \on[2]  \off[7] \\
\hline
\textbf{E2.A6.} Implementaci\'{o}n un solo VANT   \off[2] \on[2]  \off[8] \\
\hline
\textbf{E2.A7.} Simulaci\'{o}n un solo VANT  \off[2] \on[2]  \off[8] \\
\hline
\textbf{E2.A8.} Desarrollo de coordinaci\'{o}n  \off[2] \on[2]  \off[8] \\
\hline
\textbf{E2.A9.} Implementaci\'{o}n multi-VANT  \off[2] \on[2]  \off[8] \\
\hline
\textbf{E2.A10.} Simulaci\'{o}n multi-VANT \off[2] \on[2]  \off[8] \\
\hline
\textbf{E2.A11.} Documentaci\'{o}n Etapa 2  \off[2] \on[2]  \off[8] \\
\hline
\textbf{E2.A12.} Revisi\'{o}n de tesis  \off[2] \on[2]  \off[8] \\
\hline
\textcolor{black}{\textbf{Etapa 3}}\\
\hline
\textbf{E3.A1.} Experimentaci\'{o}n de soluci\'{o}n   \off[8] \on[1]  \off[3] \\
\hline
\textbf{E3.A2.} Recopilaci\'{o}n resultados   \off[8] \on[1]  \off[3] \\
\hline
\textbf{E3.A3.} Documentaci\'{o}n Etapa 3  \off[8] \on[1]  \off[3] \\
\hline
\textbf{E3.A4.} Revisi\'{o}n de tesis \off[8] \on[1]  \off[3] \\
\hline
\textbf{E3.A5.} Divulgaci\'{o}n  \off[8] \on[1]  \off[3] \\
\hline
...
%La planificaciÃ³n de trayectorias tambiÃ©n ha abordado la problemÃ¡tica de la planificaciÃ³n de mÃºltiples robots. Se han desarrollado algoritmos que permiten a los robots colaborar y coordinarse para evitar colisiones y mejorar la eficiencia en sus tareas. Estos enfoques utilizan tÃ©cnicas de planificaciÃ³n centralizada o descentralizada, y pueden basarse en mÃ©todos de bÃºsqueda o algoritmos de optimizaciÃ³n multiobjetivo.\\
...
%La asignaciÃ³n de tareas es otro aspecto crucial en la colaboraciÃ³n de mÃºltiples VANTs. Los VANTs deben ser capaces de dividir y asignar las tareas de manera Ã³ptima, considerando factores como la capacidad de carga, la distancia a las ubicaciones objetivo y los recursos disponibles. Se han propuesto diferentes estrategias de asignaciÃ³n de tareas, como algoritmos basados en la teorÃ­a de grafos y enfoques basados en tÃ©cnicas de optimizaciÃ³n.\\
...
%La planificaciÃ³n de trayectorias en robÃ³tica mÃ³vil es un campo de investigaciÃ³n fundamental que se enfoca en desarrollar algoritmos y tÃ©cnicas para que los robots mÃ³viles puedan determinar rutas Ã³ptimas y seguras para navegar en entornos complejos. Esta Ã¡rea ha experimentado avances significativos en las Ãºltimas dÃ©cadas, impulsada por el creciente interÃ©s en aplicaciones como la navegaciÃ³n autÃ³noma, la logÃ­stica y la robÃ³tica de servicio. A continuaciÃ³n, se presenta un estado del arte sobre la planificaciÃ³n de trayectorias en robÃ³tica mÃ³vil.\\

%Un enfoque comÃºn en la planificaciÃ³n de trayectorias es la bÃºsqueda basada en grafos. Los algoritmos de bÃºsqueda en grafos, como el algoritmo A*, permiten encontrar rutas Ã³ptimas en entornos discretizados. Estos algoritmos generan un grafo que representa el espacio de configuraciÃ³n del robot, donde los nodos son posiciones posibles y las aristas representan transiciones entre ellas. Sin embargo, estos enfoques enfrentan desafÃ­os en entornos de alta dimensionalidad y con obstÃ¡culos dinÃ¡micos, ya que la construcciÃ³n y bÃºsqueda del grafo pueden volverse computacionalmente costosas.\\
...
%La visualizaciÃ³n y la interacciÃ³n con los mapas 3D tambiÃ©n han sido objeto de investigaciÃ³n. Se han desarrollado herramientas de visualizaciÃ³n interactiva que permiten a los usuarios explorar y analizar los mapas 3D generados. Estas herramientas pueden incluir capacidades de navegaciÃ³n, anÃ¡lisis de datos y anotaciÃ³n de objetos para facilitar la comprensiÃ³n y el uso de los mapas 3D en aplicaciones especÃ­ficas.\\
...
%\item Peter E. Hart, Nils J. Nilsson, Bertram Raphael, A Formal Basis for the Heuristic Determination of Minimum Cost Paths, IEEE Transactions on Systems Science and Cybernetics, vol. 4, pÃ¡g 100-107, 1968

%\item A. Stentz, Optimal and efficient path planning for partially-known environments, Proc. of IEEE Conference on Robotic Automation, pÃ¡g 1058-1068, 1994
...
%\item Morbidi, F.; Cano, R.; Lara, D. Minimum-energy path generation for a quadrotor UAV. In Proceedings of the IEEE InternationalvConference on Robotics and Automation, Stockholm, Sweden, %16â21 May 2016; pp. 1492â1498.

%\item Zhang, X.Y.; Duan, H.B. An improved constrained differential evolution algorithm for unmanned aerial vehicle global route planning. Appl. Soft Comput. 2015, 26, %270â284

%\item Chen, Y.; Luo, G.; Mei, Y.; Yu, J.; Su, X. UAV Path Planning Using Artificial Potential Field Method Updated by Optimal Control Theory. Int. J. Syst. Sci. 2014, 47, %1407â1420

%\item Huang, S.; Teo, R.S.H. Computationally Efficient Visibility Graph-Based Generation Of 3D Shortest Collision-Free Path Among Polyhedral Obstacles For Unmanned Aerial Vehicles. In Proceedings of the International Conference on Unmanned Aircraft Systems, Atlanta, GA, USA, %11â14 June 2019; pp. 1218â1223.

%\item Maini, P.; Sujit, P.B. Path planning for a UAV with kinematic constraints in the presence of polygonal obstacles. In Proceedings of the International Conference on Unmanned Aircraft Systems, Arlington, VA, USA,% 7â10 June 2016; pp. %62â67.

%\item Canny, J.; Reif, J. New lower bound techniques for robot motion planning problems. In Proceedings of the 28th Annual Symposium on Foundations of Computer Science, Los Angeles, CA, USA, %12â14 October 1987; pp. 49â60.
%\end{enumerate}
