...
\begin{tabular}{ |p{2cm}|p{1.5cm}|p{1.5cm}|p{1.4cm}|p{6cm}|  }
  \hline
    ...
    \begin{itemize}[leftmargin=*, noitemsep, topsep=0pt]
    \tiny \item Eficiente para problemas con consultas m\'{u}ltiples
...
\begin{center}
    \begin{tabular}{ | l | l | l | l | l | l | p{1.5cm} |}
      ...
      \cite{USENKO2017}&Egocentric Grid&Oct-tree&A*&Gazebo&LiDAR&\ding{55}\\ \hline
      \cite{MOHTA2017}&3D local map and 2D global map&Oct-tree&A*&Gazebo&LiDAR&\ding{55}\\ \hline
      \cite{LIN2017}&TSDF&Celdas&D* Lite&Gazebo&Camara&\ding{55}\\ \hline
      \cite{PAPACHRISTOS2017}&Octomap&Grafo&RRT&Gazebo&LiDAR&\ding{55}\\ \hline
      \cite{OLEYNIKOVA2018}&Voxel Hashing TSDF \& ESDF&Oct-tree&A*&Gazebo&LiDAR&\ding{55}\\ \hline
      \cite{GAO2018}&Regular ESDF Grid Map&Oct-tree&A*&NA&LiDAR&\ding{55}\\ \hline
      \cite{FLORENCE2018}&Search over views&Oct-tree&A*&NA&LiDAR&\ding{55}\\ \hline
      \cite{SELIN2019}&Octomap&Oct-tree&A*&Gazebo&LiDAR&\ding{55}\\ \hline
      \cite{COLLINS2019}&KD Tree $+$ Sliding Voxel Map &Voronoi&A*&Gazebo&LiDAR&\ding{55}\\ \hline
      \cite{CINVES2021}&Octree&Grafo&RRT*&Gazebo&Camara&\ding{55}\\ \hline
      \cite{RACER2022}&HGrid&Grafo&RRT&Gazebo&Camara&\ding{51}\\ \hline
      \cite{WESTHEIDER2023}&Grid Mapping&Grafo&RRT&Gazebo&LiDAR&\ding{51}\\ \hline
      \cite{BARTOLOMEI2023}&Grid Mapping&Grafo&RRT&NA&Camara&\ding{51}\\ \hline
    \end{tabular}
\end{center}
\end{landscape}
