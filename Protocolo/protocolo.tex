...
\noindent
%\textbf{Particulares} \\
De manera m\'{a}s espec\'{i}fica, se encuentr\'{a}n los siguientes objetivos secundarios:
\begin{itemize}
%\item Generaci\'{o}n del modelado de la din\'{a}mica de un Veh\'{i}culo A\'{e}reo No Tripulado.
...
\item Investigar y analizar las aplicaciones de coordinaci\'{o}n multi-VANT en diversos campos.
\item Evaluar las principales limitaciones y desaf\'{i}os asociados con la coordinaci\'{o}n de m\'{u}ltiples VANT, como la comunicaci\'{o}, el control de colisiones, la asignac\'{o}n de tareas y la sincronizaci\'{o}n.
\item Dise\~{n}ar y desarrollar algoritmos y estrategias de coordinaci\'{o}n para optimizar la interacci\'{o}n entre m\'{u}ltiples UAV, considerando aspectos como la distribuci\'{o}n de tareas, el enrutamiento eficiente, la colaboraci\'{o}n y el intercambio de informaci\'{o}n.
\item Realizar simulaciones y pruebas de las estrategias propuestas utilizando plataformas de simulaci\'{o}n, evaluando su desempe\~{n}o en t\'{e}rminos de tiempo de respuesta, eficiencia en la asignaci\'{o}n de recursos, seguridad y capacidad de adaptaci\'{o}n a situaciones cambiantes.
\item Comparar y analizar los resultados obtenidos con enfoques existentes en la coordinaci\'{o}n de VANTs, demostrando las ventajas y contribuciones de las estrategias propuestas.
\item Proponer recomendaciones y pautas pr\'{a}cticas para la implementaci\'{o}n y aplicaci\'{o}n de las estrategias de coordinaci\'{o}n multi UAV en escenarios reales, considerando factores como la escalabilidad, la robustez y los recursos computacionales requeridos.
\end{itemize}

\newpage
\section*{Metodolog\'{\i}a}

La metodolog\'{i}a propuesta para esta tesis se divide en tres etapas, iniciando en septiembre del 2023. A continuaci\'{o}n se detallan cada una de las actividades que se plantean realizar en cada una.
