...
\begin{frame}{Descripción del proyecto}
  ...
  \begin{minipage}{0.5\textwidth}
    \only<1>{\includegraphics[width=\textwidth]{turquia1}}
    \only<2>{\includegraphics[width=\textwidth]{turquia2}}
    \only<3>{\includegraphics[width=\textwidth]{turquia1}}
    \only<4>{\includegraphics[width=\textwidth]{turquia2}}
    \only<5>{\includegraphics[width=\textwidth]{turquia1}}
  \end{minipage}
\end{frame}
